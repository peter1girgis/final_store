<div>
                                    ...
                                    @foreach ($mainCategories as $index => $cat)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" wire:click.prevent="confirmMainCategoryRemoval({{ $cat->id }})">
    ...
    <div class="modal fade" id="formCategory" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <form wire:submit.prevent="{{ $showEditModal ? 'updateMainCategory' : 'createMainCategory' }}" enctype="multipart/form-data">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-outline-danger" wire:click="deleteMainCategory">Yes, Delete</button>
                </div>
            </div>
        </div>
    </div>
